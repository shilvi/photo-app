...
from tests.test_bookmarks import TestBookmarkListEndpoint, TestBookmarkDetailEndpoint
...
from tests.test_like_comment import TestLikeCommentListEndpoint, TestLikeCommentDetailEndpoint
